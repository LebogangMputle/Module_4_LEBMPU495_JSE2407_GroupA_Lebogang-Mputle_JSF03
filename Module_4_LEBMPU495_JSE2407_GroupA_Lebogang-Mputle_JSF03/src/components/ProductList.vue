<template>
    <div class="p-4 bg-[#caf0f8]">
      ...
      <div class="flex items-center justify-between mb-4">
        <div>
          <select class="p-2 border rounded" v-model="selectedCategory" @change="getProduct">
        ...
        <div class="flex-1 mx-4">
          <input type="text" placeholder="Search products..." class="w-full p-2 border rounded" v-model="searchQuery" @input="filterProducts" />
        </div>
        <div>
          <select class="p-2 border rounded" v-model="sortOrder" @change="sortProducts">
